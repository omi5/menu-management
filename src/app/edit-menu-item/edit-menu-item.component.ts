...
export class EditMenuItemComponent implements OnInit{
  ngOnInit(): void {
   console.log("This is the selected item:", this.selectedMenuItem);
   console.log('THis is just the item:', this.item);
  }
  // ngOnInit(): void {
  //   this.loadingData()
  // }
...
//     console.log('This is the item:', this.selectedMenuItem)
